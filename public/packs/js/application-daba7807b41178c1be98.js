    ...
    xhr.onload = function () {
      if (xhr.status === 200) {
        ...
        if (responseData.liked) {
          e.target.innerHTML = '<i class="fa-solid fa-thumbs-up"></i>'; // Change to thumbs-up icon
        } else {
          e.target.innerHTML = '<i class="fa-solid fa-thumbs-down"></i>';
        }
...
/******/ })()
;
//# sourceMappingURL=application-daba7807b41178c1be98.js.map