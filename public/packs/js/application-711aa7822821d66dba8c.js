    ...
    xhr.onload = function () {
      if (xhr.status === 200) {
        ...
        if (responseData.liked) {
          e.target.className = 'fa-solid fa-thumbs-down like-button';
        } else {
          e.target.className = 'fa-solid fa-thumbs-down like-down';
        }
...
/******/ })()
;
//# sourceMappingURL=application-711aa7822821d66dba8c.js.map